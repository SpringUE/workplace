...
const frameIn = [
  ...
  // amazon
  {
    ...
    name: 'amazon',
    meta,
    redirect: { name: 'amazon-index' },
    component: layoutHeaderAside,
    children: (pre => [
      // { path: 'stock', name: `${pre}stock`, component: () => import('@/pages/amazon/stock/index.vue'), meta: { ...meta, title: '库存管理' } },
      // { path: 'sales-analysis', name: `${pre}sales-analysis`, component: () => import('@/pages/amazon/sales-analysis/index.vue'), meta: { ...meta, title: '销售分析' } },
      { path: 'excel-to-4px', name: `${pre}amazon-xlsx`, component: () => import('@/pages/amazon/excel-to-4px/index.vue'), meta: { ...meta, title: '订单转换4px' } }
    ])('amazon-')
  },
  // spiders
  {
    ...
    name: 'spiders',
    meta,
    redirect: { name: 'spiders-index' },
    component: layoutHeaderAside,
    children: (pre => [
      { path: 'index', name: `${pre}index`, component: () => import('@/pages/spiders/index.vue'), meta: { ...meta, title: 'Spiders总览' } },
      { path: 'bee', name: `${pre}bee`, component: () => import('@/pages/spiders/news/bee.vue'), meta: { ...meta, title: '小蜜蜂' } },
      { path: 'bee-views/:id', name: `${pre}bee-views`, component: () => import('@/pages/spiders/news/bee-views.vue'), meta: { ...meta, title: '采集信息' } }
    ])('spiders-')
  }
]
